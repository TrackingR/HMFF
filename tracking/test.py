...
def main():
    ...
    parser.add_argument('--tracker_name', default='tbsi_track', type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default='vitb_256_tbsi_32x1_1e4_lasher_15ep_sot', type=str, help='Name of config file.')
