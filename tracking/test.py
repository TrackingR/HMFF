...
def main():
    ...
    parser.add_argument('--tracker_name', default='', type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default='', type=str, help='Name of config file.')
